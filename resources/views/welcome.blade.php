...
@section('content')
    ...
    <section class="relative min-h-screen flex items-center justify-center hero-bg">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="animate-fade-in-up">
                ...
                <p class="text-xl md:text-2xl text-green-100 mb-12 max-w-4xl mx-auto leading-relaxed">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="{{ auth()->check() ? route('home') : route('register') }}"
                        class="group bg-white text-green-600 hover:bg-green-50 px-10 py-4 rounded-2xl text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl">
                    ...
                    <a href="#features"
                        class="glass-effect text-white hover:bg-white/20 px-10 py-4 rounded-2xl text-xl font-bold transition-all duration-300 transform hover:scale-105 border-2 border-white/30">
    ...
    <!-- Features Section -->
    <section id="features" class="py-20 bg-gradient-to-br from-gray-50 to-white relative">
        <!-- Background Pattern -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <div
                        class="feature-icon w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
    ...
    <section class="py-20 bg-gradient-to-br from-green-50 to-blue-50 relative overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full opacity-10">
            <div class="blob absolute top-10 left-10 w-32 h-32 bg-green-300"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="text-center animate-slide-in-left">
                    <div
                        class="step-number w-24 h-24 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-xl">
                ...
                <div class="text-center animate-fade-in-up" style="animation-delay: 0.2s;">
                    <div
                        class="step-number w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-xl">
                        <span class="text-3xl font-bold text-white">2</span>
                    </div>
                    <div class="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Verifikasi Admin</h3>
                ...
                <div class="text-center animate-slide-in-right" style="animation-delay: 0.4s;">
                    <div
                        class="step-number w-24 h-24 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-xl">
                        <span class="text-3xl font-bold text-white">3</span>
                    </div>
                    <div class="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Buat Pohon Keluarga</h3>
    ...
    <section class="py-20 bg-gradient-to-br from-green-600 via-green-700 to-green-800 relative overflow-hidden">
        ...
        <div class="absolute inset-0">
            <div class="absolute top-0 left-0 w-full h-full opacity-20">
                <div class="animate-float absolute top-20 left-20 w-20 h-20 bg-white/10 rounded-full"></div>
                <div class="animate-float absolute bottom-20 right-20 w-16 h-16 bg-white/10 rounded-full"
                    style="animation-delay: 1s;"></div>
                <div class="animate-float absolute top-1/2 left-1/4 w-12 h-12 bg-white/10 rounded-full"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <div class="animate-fade-in-up">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                    Mulai Membangun <span class="text-green-200">Warisan Keluarga</span> Anda
                </h2>
                ...
                <div class="animate-pulse-slow">
                    <a href="{{ auth()->check() ? route('home') : route('register') }}"
                        class="group bg-white text-green-600 hover:bg-green-50 px-12 py-5 rounded-2xl text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl inline-flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <div
                            class="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors cursor-pointer">
                        ...
                        <div
                            class="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-400 transition-colors cursor-pointer">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div class="animate-slide-in-left">
                    <h4 class="text-2xl font-bold mb-6 text-green-400">Tautan Cepat</h4>
                    <ul class="space-y-4">
                        <li>
                            <a href="{{ route('login') }}"
                ...
                <div class="animate-slide-in-right">
                    <h4 class="text-2xl font-bold mb-6 text-green-400">Kontak Kami</h4>
                    <ul class="space-y-4">
