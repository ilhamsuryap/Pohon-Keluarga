                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" 
                                   ...
                                   placeholder="50000"
                                   value="{{ $setting ? $setting->registration_fee : 50000 }}"
                                   min="0"
                                   step="1000"
                                   required>
                ...
                @if($setting)
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="text-sm text-gray-600 space-y-1">
                            <p>Biaya Pendaftaran: <span class="font-medium">Rp {{ number_format($setting->registration_fee, 0, ',', '.') }}</span></p>
                            <p>Status: <span class="font-medium {{ $setting->is_active ? 'text-green-600' : 'text-red-600' }}">{{ $setting->is_active ? 'Aktif' : 'Tidak Aktif' }}</span></p>
                            <p>Terakhir Diperbarui: <span class="font-medium">{{ $setting->updated_at->format('d F Y H:i') }}</span></p>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    ...
                                    <li>Contoh: Jika biaya Rp 50.000, user akan bayar Rp 50.123 (dengan kode unik 123)</li>
